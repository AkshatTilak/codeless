...
from codeless.jobs.manager import BackgroundTaskManager, _encode_task_worker_payload
...
async def test_write_to_stopped_agent_task_restarts_process(tmp_path: Path, monkeypatch):
    ...
    assert "[Codeless] Agent task restarted; prior interactive context was not preserved." in output
