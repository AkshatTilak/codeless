"""Tests for codeless.prompts.environment."""
...
from codeless.prompts.environment import (
    EnvironmentInfo,
    detect_git_info,
    detect_os,
    detect_shell,
...
def test_detect_git_info_uses_devnull_for_git_subprocess(monkeypatch):
    ...
    monkeypatch.setattr("codeless.prompts.environment.subprocess.run", _fake_run)
...
def test_get_environment_info_detects_virtual_env_from_python_executable(
    ...
    monkeypatch.setattr("codeless.prompts.environment.sys.executable", str(fake_python))
