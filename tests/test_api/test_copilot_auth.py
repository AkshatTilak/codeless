...
from codeless.api.copilot_auth import (
...
class TestTokenPersistence:
    ...
    def test_save_and_load_round_trip(self, tmp_path: Path, monkeypatch):
        monkeypatch.setenv("CODELESS_CONFIG_DIR", str(tmp_path / "cfg"))
    ...
    def test_load_returns_none_on_corrupt_json(self, tmp_path: Path, monkeypatch):
        ...
        monkeypatch.setenv("CODELESS_CONFIG_DIR", str(cfg_dir))
...
class TestRequestDeviceCode:
    ...
    def test_request_device_code_happy_path(self, monkeypatch):
        ...
        monkeypatch.setattr("codeless.api.copilot_auth.httpx.post", fake_post)
...
class TestPollForAccessToken:
    ...
    def test_returns_token_after_pending(self, monkeypatch):
        ...
        monkeypatch.setattr("codeless.api.copilot_auth.httpx.post", fake_post)
        monkeypatch.setattr("codeless.api.copilot_auth.time.sleep", lambda _: None)
    ...
    def test_slow_down_increases_interval(self, monkeypatch):
        ...
        monkeypatch.setattr("codeless.api.copilot_auth.httpx.post", fake_post)
        monkeypatch.setattr("codeless.api.copilot_auth.time.sleep", fake_sleep)
    ...
    def test_timeout_raises_runtime_error(self, monkeypatch):
        ...
        monkeypatch.setattr("codeless.api.copilot_auth.httpx.post", fake_post)
        monkeypatch.setattr("codeless.api.copilot_auth.time.sleep", lambda _: None)
        monkeypatch.setattr("codeless.api.copilot_auth.time.monotonic", fake_monotonic)
