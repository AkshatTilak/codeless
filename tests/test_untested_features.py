...
async def test_hooks_in_agent_loop():
    ...
    from codeless.engine.stream_events import AssistantTextDelta, ToolExecutionStarted, ToolExecutionCompleted
    from codeless.permissions.checker import PermissionChecker
    from codeless.permissions.modes import PermissionMode
    from codeless.tools.base import ToolRegistry
    from codeless.tools.bash_tool import BashTool
...
async def test_memory_lifecycle():
    ...
    from codeless.memory.manager import list_memory_files, add_memory_entry, remove_memory_entry
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        p2 = add_memory_entry(tmpdir, "project-goal", "Building an AI agent framework called Codeless")
...
async def test_mcp_types():
    ...
    from codeless.mcp.types import McpStdioServerConfig, McpToolInfo, McpConnectionStatus
...
async def test_full_swarm_autoagent():
    ...
    from codeless.swarm.in_process import start_in_process_teammate, TeammateAbortController
