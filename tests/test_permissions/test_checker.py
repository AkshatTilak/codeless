...
from codeless.config.settings import PathRuleConfig, PermissionSettings
from codeless.permissions import PermissionChecker, PermissionMode
from codeless.permissions.checker import SENSITIVE_PATH_PATTERNS
...
def test_invalid_pattern_rule_is_skipped_and_warns(bad_rule, caplog):
    ...
    with caplog.at_level(logging.WARNING, logger="codeless.permissions.checker"):
...
class TestSensitivePathProtection:
    ...
    def test_full_auto_blocks_sensitive_paths(self):
        ...
        for path in (
            ...
            "/home/user/.codeless/credentials.json",
            "/home/user/.codeless/copilot_auth.json",
        ):
    ...
    def test_every_builtin_pattern_has_coverage(self, pattern):
        ...
        example_paths = {
            ...
            "*/.codeless/credentials.json": "/home/u/.codeless/credentials.json",
            "*/.codeless/copilot_auth.json": "/home/u/.codeless/copilot_auth.json",
        }
