"""Tests for :mod:`codeless.utils.fs` atomic-write helpers."""
...
from codeless.utils.fs import atomic_write_bytes, atomic_write_text
...
def test_existing_file_is_untouched_on_write_failure(
    ...
    monkeypatch.setattr("codeless.utils.fs.os.replace", _boom)
