...
from codeless.coordinator.coordinator_mode import get_coordinator_system_prompt, is_coordinator_mode
...
def _build_delegation_section() -> str:
    ...
    return "\n".join(
        [
            ...
            "",
            "Codeless can delegate background work with the `agent` tool.",
