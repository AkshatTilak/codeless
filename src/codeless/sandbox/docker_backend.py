...
from codeless.sandbox.adapter import SandboxAvailability, SandboxUnavailableError
...
class DockerSandboxSession:
    """Manages a long-running Docker container for one Codeless session."""
    ...
    def __post_init__(self) -> None:
        self._container_name = f"codeless-sandbox-{self.session_id}"
