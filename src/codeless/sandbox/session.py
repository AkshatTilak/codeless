...
async def start_docker_sandbox(
    ...
    """Start a Docker sandbox session for the current Codeless session."""
    global _active_session  # noqa: PLW0603

    from codeless.sandbox.docker_backend import DockerSandboxSession, get_docker_availability
