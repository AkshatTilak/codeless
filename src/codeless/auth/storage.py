"""Credential storage for Codeless.

Default backend: ~/.codeless/credentials.json with mode 600.
...
def _obfuscation_key() -> bytes:
    ...
    seed = str(Path.home()).encode() + b"codeless-v1"
    import hashlib
