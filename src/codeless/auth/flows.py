...
class ApiKeyFlow(AuthFlow):
    """Prompt the user for an API key and persist it via :mod:`codeless.auth.storage`."""
...
class DeviceCodeFlow(AuthFlow):
    ...
    def __init__(
        ...
        *,
        ...
        from codeless.api.copilot_auth import COPILOT_CLIENT_ID
    ...
    def run(self) -> str:
        from codeless.api.copilot_auth import poll_for_access_token, request_device_code
