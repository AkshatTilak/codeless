"""Unified authentication manager for Codeless providers."""
...
# Providers that Codeless knows about.
_KNOWN_PROVIDERS = [
    "anthropic",
    "anthropic_claude",
    "openai",
...
class AuthManager:
    ...
    Reads/writes credentials via :mod:`codeless.auth.storage` and keeps
    ...
    def get_auth_source_statuses(self) -> dict[str, Any]:
        ...
        for source in _AUTH_SOURCES:
            ...
            if source == "anthropic_api_key":
                ...
                from codeless.api.copilot_auth import load_copilot_auth
    ...
    def save_settings(self) -> None:
        ...
        from codeless.config import save_settings
