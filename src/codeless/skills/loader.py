...
from codeless.skills._frontmatter import (
    optional_frontmatter_str,
    parse_bool_frontmatter,
    parse_skill_frontmatter,
    parse_skill_metadata,
)
from codeless.skills.bundled import get_bundled_skills
...
_DEFAULT_PROJECT_SKILL_DIRS = (".codeless/skills", ".agents/skills", ".claude/skills")


def get_user_skills_dir() -> Path:
    """Return the Codeless user skills directory."""
...
def load_user_skills() -> list[SkillDefinition]:
    """Load markdown skills from user-level Codeless and compatibility directories."""
