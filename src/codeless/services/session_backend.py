...
from codeless.services import session_storage
...
class CodelessSessionBackend:
    """Default session backend backed by ``~/.codeless/data/sessions``."""
...
DEFAULT_SESSION_BACKEND: SessionBackend = CodelessSessionBackend()
