...
from codeless.memory.relevance import build_memory_manifest
...
from codeless.memory.team import check_team_memory_secrets, validate_team_memory_write_path
...
EXTRACTION_SYSTEM_PROMPT = """You maintain Codeless durable memory.
