...
from codeless.api.codex_client import _build_codex_headers, _resolve_codex_url
from codeless.api.openai_client import _normalize_openai_base_url
    ...
    async def _generate_with_openai(self, arguments: ImageGenerationToolInput, config: dict[str, object]) -> list[str]:
        ...
        if not api_key:
            raise RuntimeError(
                ...
                "or CODELESS_IMAGE_GENERATION_API_KEY, or choose provider='codex'."
            )
