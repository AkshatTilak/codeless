...
from codeless.themes.builtin import BUILTIN_THEMES
from codeless.themes.schema import ThemeConfig
...
def get_custom_themes_dir() -> Path:
    ...
    path = Path.home() / ".codeless" / "themes"
    path.mkdir(parents=True, exist_ok=True)
    return path


def load_custom_themes() -> dict[str, ThemeConfig]:
    """Load custom themes from ~/.codeless/themes/*.json."""
