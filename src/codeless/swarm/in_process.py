...
* :class:`InProcessBackend` – implements
  :class:`~codeless.swarm.types.TeammateExecutor` and manages the dict of
  live asyncio Tasks.
"""
...
from codeless.swarm.mailbox import (
    TeammateMailbox,
...
async def start_in_process_teammate(
    *,
    ...
    2. Drives the query engine loop (reusing
       :func:`~codeless.engine.query.run_query`).
    ...
    query_context:
        Optional pre-built
        :class:`~codeless.engine.query.QueryContext`.  When *None* this
...
async def _run_query_loop(
    ...
    """Drive :func:`~codeless.engine.query.run_query` until done or cancelled.
    ...
    from codeless.engine.query import run_query
...
class InProcessBackend:
    ...
    async def send_message(self, agent_id: str, message: TeammateMessage) -> None:
        ...
        from codeless.swarm.mailbox import MailboxMessage
