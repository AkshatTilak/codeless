"""GitHub Copilot API client for Codeless.
...
from codeless.api.errors import AuthenticationFailure
...
class CopilotClient:
    ...
    github_token:
        ...
        token is loaded from ``~/.codeless/copilot_auth.json``.
    enterprise_url:
    ...
    def __init__(
        ...
        *,
        ...
        default_headers: dict[str, str] = {
            "User-Agent": f"codeless/{_VERSION}",
