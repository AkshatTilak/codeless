...
from codeless.hooks.schemas import (
    AgentHookDefinition,
...
from codeless.hooks.types import AggregatedHookResult, HookResult
...
class HookExecutor:
    ...
    async def _run_command_hook(
        ...
        try:
            process = await create_shell_subprocess(
                ...
                env={
                    **os.environ,
                    "CODELESS_HOOK_EVENT": event.value,
                    "CODELESS_HOOK_PAYLOAD": json.dumps(payload),
                },
            )
    ...
    async def _run_prompt_like_hook(
        ...
        *,
        ...
        prefix = (
            "You are validating whether a hook condition passes in Codeless. "
