...
CLI Entrypoints: `codeless` / `clh` | Config Home: `~/.codeless/`
Upstream Foundation: Hard-forked from `HKUDS/OpenHarness` (v0.1.9, Python) with isolated `src/codeless/abb/` runtime bridge.
